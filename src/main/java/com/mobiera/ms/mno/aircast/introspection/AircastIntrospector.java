package com.mobiera.ms.mno.aircast.introspection;
...
public class AircastIntrospector extends Introspector {
	...
	public List<String> getVOPackages() {
		if (defaultVOPackages == null) {
			...
			defaultVOPackages.add(com.mobiera.aircast.api.v1.landing.ListLandingsRequest.class.getPackage().getName());
	...
	public List<EnumValueVO> listEnumValueVOs(String targetClassName, Object[] consts) throws ClassNotFoundException {
		return super.listEnumValueVOs(getEnumPackages(), targetClassName, consts);
	}

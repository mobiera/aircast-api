...
public enum EndpointStat implements StatEnum {
	...
	DELIVERY_TRANSPORT_ERROR(4, "Delivery Transport Error", "Service could not connect to remote URL", true),
	DELIVERY_SOFTWARE_ERROR(5, "Delivery Software Error", "Remote Service answered an error. Delivery will be reattempted later", true);
